! function (e) {
    ...
    function u(e, t, n, r) {
        ...
        i.forEach(function (t) {
            var r = e[t]; - 1 !== o.indexOf(t) ? s(r, n, p) : a(r, n, p)
        })
    }
    ...
    var o = n(2),
        ...
        h = function (e) {
            var t = e.type,
                ...
                r = void 0 === n ? "" : n,
                o = e.spin,
                a = (0, f.default)((0, s.default)({
                    anticon: !0,
                    "anticon-spin": !!o || "loading" === t
                }, "anticon-" + t, !0), r);
            return u.createElement("i", (0, i.default)({}, (0, d.default)(e, ["type", "spin"]), {
                className: a
            }))
        };
        ...
        A = function (e) {
            ...
            return (0, m.default)(t, e), (0, f.default)(t, [{
                ...
                value: function (e, t) {
                    ...
                    (e.inlineCollapsed && !this.props.inlineCollapsed || t.siderCollapsed && !this.context.siderCollapsed) && (this.switchModeFromInline = !!this.state.openKeys.length && !!(0, g.findDOMNode)(this).querySelectorAll("." + n + "-submenu-open").length, this.inlineOpenKeys = this.state.openKeys, this.setState({
                        openKeys: []
    ...
    function s(e) {
        var t = e.prefixCls || "ant-notification",
            n = t + "-notice",
            r = void 0 === e.duration ? y : e.duration,
            o = null;
        if (e.icon) o = f.createElement("span", {
            className: n + "-icon"
        }, e.icon);
        else if (e.type) {
            var i = O[e.type];
            o = f.createElement(m.default, {
                className: n + "-icon " + n + "-icon-" + e.type,
                type: i
            })
        }
        var s = !e.description && o ? f.createElement("span", {
            className: n + "-message-single-line-auto-margin"
        }) : null;
        a(t, e.placement || w, function (t) {
            t.notice({
                content: f.createElement("div", {
                    ...
                    className: n + "-message"
                }, s, e.message), f.createElement("div", {
                    className: n + "-description"
                }, e.description), e.btn ? f.createElement("span", {
                    className: n + "-btn"
                }, e.btn) : null),
                duration: r,
                closable: !0,
    ...
    function r(e, t) {
        return e = e || 0, t = t || h.j, m({
            url: h.b + "/polls?page=" + e + "&size=" + t,
            method: "GET"
        })
    }
    ...
    function l(e) {
        return m({
            url: h.b + "/user/checkUsernameAvailability?username=" + e,
            method: "GET"
        })
    }
    ...
    function u(e) {
        return m({
            url: h.b + "/user/checkEmailAvailability?email=" + e,
            method: "GET"
        })
    }
    ...
    var i = n(2),
        ...
        _ = function (e) {
            function t(e) {
                ...
                return P.call(n), n.currentlyAnimatingKeys = {}, n.keysToEnter = [], n.keysToLeave = [], n.state = {
                    children: Object(C.e)(r(e))
                }, n.childrenRefs = {}, n
            }
            return v()(t, e), p()(t, [{
                ...
                value: function (e) {
                    ...
                    var i = o.showProp,
                        ...
                        s = o.exclusive ? Object(C.e)(r(o)) : this.state.children,
                        u = [];
                    ...
                    })) : u = Object(C.d)(s, n), this.setState({
                        children: u
                    }), n.forEach(function (e) {
                        var n = e && e.key;
                        if (!e || !a[n]) {
        ...
        this.performEnter = function (t) {
            ...
            if (delete e.currentlyAnimatingKeys[t], !n.exclusive || n === e.nextProps) {
                ...
                if (e.isValidChildByKey(o, t)) e.performEnter(t);
                    ...
                    Object(C.c)(e.state.children, o, n.showProp) ? i() : e.setState({
                        children: o
                    }, i)
                }
            }
            ...
            return (0, m.default)(t, e), (0, f.default)(t, [{
                ...
                value: function () {
                    var e, t = this.props,
                        ...
                        a = t.children,
                        l = t.style,
                        u = P(t, ["prefixCls", "className", "children", "style"]),
                        c = n.radioGroup,
                        f = (0, s.default)({}, u);
    ...
    t.default = k, k.defaultProps = {
        ...
        radioGroup: b.default.any
    }, e.exports = t.default
}, function (e, t, n) {
    "use strict";

    function r(e) {
        var t = f.a.createElement(u.a, {
    ...
    function h(e, t) {
        ...
        return O.a.Children.forEach(e, function (e) {
            if (e.type.isMenuItemGroup) n = n.concat(h(e.props.children, t));
            else {
                var o = r(e),
                    i = e.key; - 1 !== p(t, o) && i && n.push(i)
            }
        }), n
    }
    ...
    e.exports = function (e, t, n, m, v, y, g) {
        ...
        var b, w, C, O = function (e) {
            ...
            _ = !1,
            P = e.prototype,
            k = P[p] || P["@@iterator"] || v && P[v],
            T = !d && k || O(v),
            S = v ? E ? O("entries") : T : void 0,
        ...
        if (N && (C = f(N.call(new e))) !== Object.prototype && C.next && (c(C, x, !0), r || s(C, p) || a(C, p, h)), E && k && "values" !== k.name && (_ = !0, T = function () {
                return k.call(this)
            }), r && !g || !d && !_ && P[p] || a(P, p, T), l[t] = T, l[x] = h, v)
            if (b = {
                    values: E ? T : O("values"),
                    keys: y ? T : O("keys"),
                    entries: S
                }, g)
                for (w in b) w in P || i(P, w, b[w]);
            ...
            return i(t, e), x(t, [{
                ...
                value: function () {
                    var e = this,
                        ...
                        n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : w.j,
                        r = void 0;
                    this.props.username ? "USER_CREATED_POLLS" === this.props.type ? r = Object(y.g)(this.props.username, t, n) : "USER_VOTED_POLLS" === this.props.type && (r = Object(y.i)(this.props.username, t, n)) : r = Object(y.e)(t, n), r && (this.setState({
                        isLoading: !0
                    }), r.then(function (t) {
                        var n = e.state.polls.slice(),
                            r = e.state.currentVotes.slice();
                        e.setState({
                ...
                value: function (e, t) {
                    ...
                    var r = this.state.polls[t],
                        o = this.state.currentVotes[t],
                        i = {
                            pollId: r.id,
                            choiceId: o
                        };
                ...
                value: function () {
                    ...
                    return this.state.polls.forEach(function (n, r) {
                    ...
                    }, t, this.state.isLoading || 0 !== this.state.polls.length ? null : v.a.createElement("div", {
                        className: "no-polls-found"
                    }, v.a.createElement("span", null, "No Polls Found.")), this.state.isLoading || this.state.last ? null : v.a.createElement("div", {
                        ...
                        type: "plus"
                    }), " Load more")), this.state.isLoading ? v.a.createElement(b.a, null) : null)
                }
            }]), t
        }(m.Component);
    t.a = Object(C.f)(E)
        ...
        P = function (e) {
            function t(e) {
                ...
                return n.setScale = function () {
                    ...
                    if (e) {
                        var t = e.offsetWidth,
                            r = w.findDOMNode(n).getBoundingClientRect().width;
                        r - 8 < t ? n.setState({
                            scale: (r - 8) / t
                        }) : n.setState({
                            scale: 1
            ...
            return (0, v.default)(t, e), (0, p.default)(t, [{
                ...
                value: function () {
                    var e, t, n = this,
                        ...
                        c = r.icon,
                        f = r.className,
                        p = _(r, ["prefixCls", "shape", "size", "src", "icon", "className"]),
                    ...
                    else if (c) m = g.createElement(O.default, {
                        type: c
                    });
                    else {
                    ...
                    return g.createElement("span", (0, a.default)({}, p, {
                        className: h
                    }), m)
                }
            }]), t
            ...
            return (0, v.default)(t, e), (0, p.default)(t, [{
                ...
                value: function (e) {
                    ...
                    var r = n.prefixCls + "-group",
                        o = r + "-addon",
                        i = n.addonBefore ? g.createElement("span", {
                            className: o
                        }, n.addonBefore) : null,
                        a = n.addonAfter ? g.createElement("span", {
                            className: o
                        }, n.addonAfter) : null,
                ...
                value: function (e) {
                    ...
                    var r = n.prefix ? g.createElement("span", {
                            className: n.prefixCls + "-prefix"
                        }, n.prefix) : null,
                        o = n.suffix ? g.createElement("span", {
                            className: n.prefixCls + "-suffix"
                        }, n.suffix) : null,
        ...
        return function (e) {
            var i = (0, v.default)({
                ...
                onCollectCommon: function (e, t, n) {
                    ...
                    if (r[t]) r[t].apply(r, (0, p.default)(n));
                ...
                setFieldsValue: function (e) {
                    var t = this.fieldsStore.fieldsMeta,
                        n = this.fieldsStore.flattenRegisteredFields(e),
                ...
                validateFieldsInternal: function (e, t, r) {
                    ...
                    if (e.forEach(function (e) {
                            var t = e.name;
                            if (!0 !== l.force && !1 === e.dirty) return void(e.errors && (0, _.default)(d, t, {
                                errors: e.errors
                            }));
                    ...
                    n && h.messages(n), h.validate(f, l, function (e) {
                        ...
                        e && e.length && e.forEach(function (e) {
                            var n = e.field;
                            (0, x.default)(t, n) || (0, _.default)(t, n, {
                                errors: []
                        ...
                        Object.keys(u).forEach(function (e) {
                            var r = (0, C.default)(t, e),
                                i = o.fieldsStore.getField(e);
                            i.value !== f[e] ? n.push({
                                name: e
                            }) : (i.errors = r && r.errors, i.value = f[e], i.validating = !1, i.dirty = !1, a[e] = i)
                ...
                render: function () {
                    var t = this.props,
                        ...
                        r = (0, a.default)(t, ["wrappedComponentRef"]),
        ...
        S = function (e) {
            ...
            return (0, y.default)(t, e), (0, d.default)(t, [{
                        ...
                        return _.register(T[t], {
                            match: function () {
                                "object" === (0, u.default)(e.props.gutter) && e.setState(function (e) {
                                    return {
                                        screens: (0, s.default)({}, e.screens, (0, i.default)({}, t, !0))
                                    }
                                })
                            },
                            unmatch: function () {
                                "object" === (0, u.default)(e.props.gutter) && e.setState(function (e) {
                                    return {
                                        screens: (0, s.default)({}, e.screens, (0, i.default)({}, t, !1))
                                    }
                                })
                            },
                            destroy: function () {}
                ...
                value: function () {
                    ...
                    if ("object" === ("undefined" === typeof e ? "undefined" : (0, u.default)(e)))
                ...
                value: function () {
                    var e, t = this.props,
                        ...
                        y = (0, s.default)({}, p);
                    return delete y.gutter, b.createElement("div", (0, s.default)({}, y, {
                        className: h,
                        style: m
                    }), v)
                }
    ...
    var o = n(7),
        ...
        P = C.default.oneOfType([C.default.object, C.default.number]),
        k = function (e) {
            function t() {
            ...
            return (0, y.default)(t, e), (0, d.default)(t, [{
                ...
                value: function () {
                    var e, t = this.props,
                        ...
                        h = E(t, ["span", "order", "offset", "push", "pull", "className", "children", "prefixCls"]),
                        m = {};
                    ...
                    return b.createElement("div", (0, s.default)({}, h, {
                        className: v
                    }), f)
                }
            }]), t
    ...
    var a = n(2),
        ...
        O = {
            ...
            onKeyDown: function (e, t) {
                ...
                var i = null;
                return r !== h.a.UP && r !== h.a.DOWN || (i = this.step(r === h.a.UP ? -1 : 1)), i ? (e.preventDefault(), this.setState({
                    activeKey: i.props.eventKey
                }, function () {
                    b()(d.a.findDOMNode(i), d.a.findDOMNode(n), {
                        onlyScrollIfNeeded: !0
                    }), "function" === typeof t && t(i)
                }), 1) : void 0 === i ? (e.preventDefault(), this.setState({
                    activeKey: null
                }), 1) : void 0
            },
            ...
            step: function (e) {
                ...
                if (t.every(function (e, t) {
                    ...
                    }), this.props.defaultActiveFirst || -1 === i || !r(t.slice(i, o - 1)))
                    for (var a = (i + 1) % o, s = a;;) {
                        var l = t[s];
    ...
    function r(e) {
        ...
        for (r = e.parentNode; r && r !== n; r = r.parentNode)
            if ("static" !== (i = o.a.css(r, "position"))) return r;
        return null
    }
    var o = n(46);
    t.a = r
    ...
    var o = n(2),
        ...
        c = {
            ...
            timePickerLocale: (0, i.default)({}, u.default)
        };
                ...
                value: function () {
                    ...
                    return w.createElement(E.default, (0, a.default)({}, this.props, {
                        ...
                        renderTabContent: function () {
                            return w.createElement(T.default, {
                                animated: S,
    ...
    t.default = R, R.TabPane = x.TabPane, R.defaultProps = {
        prefixCls: "ant-tabs",
        hideAdd: !1
    }, e.exports = t.default
}, function (e, t, n) {
            ...
            return i(t, e), d(t, [{
                ...
                value: function () {
                    return c.a.createElement("div", {
                        ...
                        className: "title"
                    }, "404"), c.a.createElement("div", {
                        className: "desc"
                    }, "The Page you're looking for was not found."), c.a.createElement(p.b, {
                        to: "/"
            ...
            return (0, d.default)(t, e), (0, u.default)(t, [{
                ...
                value: function () {
                    var e = this.props,
                        ...
                        l = m.Children.only(r),
                        u = m.cloneElement(s, {
                            className: (0, b.default)(s.props.className, n + "-trigger"),
                            disabled: a
                        }),
                        c = l.props.selectable || !1,
                        f = m.cloneElement(l, {
                            mode: "vertical",
                            selectable: c
                        });
    ...
    function l(e, t, n) {
        var r, o = {},
            ...
            a = null;
        if (null != t)
            for (r in void 0 !== t.ref && (a = t.ref), void 0 !== t.key && (i = "" + t.key), t) j.call(t, r) && !A.hasOwnProperty(r) && (o[r] = t[r]);
    ...
    function d(e, t, n, o) {
        ...
        if (a = 0, t = "" === t ? "." : t + ":", Array.isArray(e))
            for (var s = 0; s < e.length; s++) {
                ...
                var l = t + h(i, s);
                a += d(i, l, n, o)
            } else if (null === e || "undefined" === typeof e ? l = null : (l = k && e[k] || e["@@iterator"], l = "function" === typeof l ? l : null), "function" === typeof l)
                for (e = l.call(e), s = 0; !(i = e.next()).done;) i = i.value, l = t + h(i, s++), a += d(i, l, n, o);
        ...
        return {
            beginWork: function (e, t, n) {
                ...
                switch (t.tag) {
                    ...
                    case 4:
                        e: {
                            if (v(t, t.stateNode.containerInfo), i = t.pendingProps, mo.current) null === i && null == (i = e && e.memoizedProps) && r("154");
    ...
    function Nt(e, t) {
        ...
        return {
            ...
            commitPlacement: function (e) {
                ...
                for (var i = e;;) {
                    if (5 === i.tag || 6 === i.tag) n ? o ? y(t, i.stateNode, n) : v(t, i.stateNode, n) : o ? m(t, i.stateNode) : h(t, i.stateNode);
        ...
        function h(e, t) {
            for (; null !== e;) {
                if ((0 === e.expirationTime || e.expirationTime > t) && (e.expirationTime = t), null !== e.alternate && (0 === e.alternate.expirationTime || e.alternate.expirationTime > t) && (e.alternate.expirationTime = t), null === e.return) {
                    ...
                    var o = n,
                        i = t;
                    if (Oe > we && r("185"), null === o.nextScheduledRoot) o.remainingExpirationTime = i, null === le ? (se = le = o, o.nextScheduledRoot = o) : (le = le.nextScheduledRoot = o, le.nextScheduledRoot = se);
                    else {
    ...
    function cn(e, t, n, r, o) {
        ...
        for (a in n)
            if (!r.hasOwnProperty(a) && n.hasOwnProperty(a) && null != n[a])
                ...
                else "dangerouslySetInnerHTML" !== a && "children" !== a && "suppressContentEditableWarning" !== a && "suppressHydrationWarning" !== a && "autoFocus" !== a && ($n.hasOwnProperty(a) ? i || (i = []) : (i = i || []).push(a, null));
        for (a in r) {
            var l = r[a];
            ...
            else "dangerouslySetInnerHTML" === a ? (l = l ? l.__html : void 0, t = t ? t.__html : void 0, null != l && t !== l && (i = i || []).push(a, "" + l)) : "children" === a ? t === l || "string" !== typeof l && "number" !== typeof l || (i = i || []).push(a, "" + l) : "suppressContentEditableWarning" !== a && "suppressHydrationWarning" !== a && ($n.hasOwnProperty(a) ? (null != l && an(o, a), i || t === l || (i = [])) : (i = i || []).push(a, l))
        }
    ...
    var Sn = {
        ...
        Rn = jn.HAS_OVERLOADED_BOOLEAN_VALUE,
            ...
            return i(t, e), k(t, [{
                ...
                value: function () {
                    ...
                    localStorage.removeItem(y.a), this.setState({
                        currentUser: null,
                        isAuthenticated: !1
                    }), this.props.history.push(e), f.a[t]({
                        message: "Polling App",
                        description: n
                    })
                }
                ...
                value: function () {
                    var e = this;
                    return this.state.isLoading ? d.a.createElement(_.a, null) : d.a.createElement(l.a, {
                        ...
                        className: "container"
                    }, d.a.createElement(m.e, null, d.a.createElement(m.d, {
                        exact: !0,
                        path: "/",
                        render: function (t) {
        ...
        return function (t) {
            return function (n) {
                ...
                return (0, g.default)(r, n), (0, h.default)(r, [{
                    ...
                    value: function () {
                        var n = e.prefixCls;
                        return w.createElement(t, (0, c.default)({
                            prefixCls: n
                        }, this.props))
                    }
                }]), r
            ...
            return (0, g.default)(t, e), (0, h.default)(t, [{
                ...
                value: function () {
                    var e = this.props,
                        ...
                        n = e.className,
                        r = e.children,
                        o = _(e, ["prefixCls", "className", "children"]),
                        i = (0, E.default)(n, t);
                    return w.createElement("div", (0, c.default)({
                        className: i
                    }, o), r)
                }
            }]), t
                ...
                value: function () {
                    ...
                    return {
                        siderHook: {
                            addSider: function (t) {
                                e.setState({
                                    siders: [].concat((0, l.default)(e.state.siders), [t])
                                })
                            },
    ...
    var r = n(30),
        ...
        Y = function (e, t, n) {
            return e === U && Y(V, t, n), g(e), t = C(t, !0), g(n), o(L, t) ? (n.enumerable ? (o(e, F) && e[F][t] && (e[F][t] = !1), n = x(n, {
                enumerable: O(0, !1)
            })) : (o(e, F) || S(e, F, O(1, {})), e[F][t] = !0), W(e, t, n)) : S(e, t, n)
        },
        G = function (e, t) {
            g(e);
        ...
        N = function (e) {
            function t(e) {
                ...
                n.responsiveHandler = function (e) {
                    ...
                    "collapsed" in n.props || n.setState({
                        collapsed: e
                    });
                ...
                var o = void 0;
                return o = "collapsed" in e ? e.collapsed : e.defaultCollapsed, n.state = {
                    collapsed: o,
                    below: !1
                }, n
            }
            return (0, m.default)(t, e), (0, f.default)(t, [{
                ...
                value: function () {
                    var e, t = this.props,
                        ...
                        }, y.createElement(_.default, {
                            type: "bars"
                        })) : null,
                        v = {
                            expanded: a ? y.createElement(_.default, {
                                type: "right"
                            }) : y.createElement(_.default, {
                                type: "left"
                            }),
                            collapsed: a ? y.createElement(_.default, {
                                type: "left"
                            }) : y.createElement(_.default, {
                                type: "right"
                            })
                    ...
                    return y.createElement("div", (0, s.default)({
                        className: E
                    }, d, {
                        style: x
                    }), y.createElement("div", {
                        className: n + "-children"
                    }, this.props.children), o || this.state.below && m ? O : null)
                }
            }]), t
        }(y.Component);
    ...
    var o = n(28),
        ...
        M = function (e) {
            function t() {
                ...
                return n = o = m()(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(s))), o.state = {
                    notices: []
                }, o.add = function (e) {
                    var t = e.key = e.key || r();
                ...
                value: function () {
                    var e, t = this,
                        ...
                        r = this.state.notices.map(function (e) {
                            ...
                            return b.a.createElement(T.a, u()({
    ...
    M.propTypes = {
        ...
        var l = !1;
        x.a.render(b.a.createElement(M, u()({}, a, {
            ref: n
        })), s)
    }, t.a = M
}, function (e, t, n) {
                        ...
                        if (e) {
                            ...
                            if (n)
                                if (t.replaceState({
                                    ...
                                    var u = N.indexOf(B.location.key); - 1 !== u && (N[u] = i.key), x({
                                        action: "REPLACE",
                                        location: i
                                    })
                                }
    ...
    var o = Object.assign || function (e) {
        ...
        g = function () {
            ...
            var t = window.history,
                ...
                S = function (e) {
                    var t = z.location,
                        n = A.lastIndexOf((0, c.createPath)(t)); - 1 === n && (n = 0);
                    var r = A.lastIndexOf((0, c.createPath)(e)); - 1 === r && (r = 0);
                    var o = n - r;
                    o && (_ = !0, R(o))
                },
                N = m(),
                    ...
                    x.confirmTransitionTo(n, "REPLACE", i, function (e) {
                        if (e) {
                            var t = (0, c.createPath)(n),
                                r = w(g + t);
                            m() !== r && (P = t, y(r));
                            var o = A.indexOf((0, c.createPath)(z.location)); - 1 !== o && (A[o] = t), E({
                                action: "REPLACE",
                                location: n
                            })
                        }
    ...
    var s = n(10),
        ...
        _ = function (e) {
            ...
            return a(t, e), t.prototype.getChildContext = function () {
                ...
                return p.a.createElement(v.a, y({}, o, {
                    history: i
                }))
            }, t
        }(p.a.Component);
        ...
        j = function (e) {
            ...
            return (0, y.default)(t, e), (0, d.default)(t, [{
                ...
                value: function () {
                    ...
                    this.isNeedInserted() && M(e) && this.setState({
                        hasTwoCNChar: !0
                    })
                }
            }, {
    ...
    var o = n(2),
        ...
        d = function (e) {
            var t = e.prefixCls,
                ...
                r = e.size,
                o = e.className,
                a = p(e, ["prefixCls", "size", "className"]),
                l = "";
            switch (r) {
                case "large":
                    l = "lg";
            ...
            return u.createElement("div", (0, i.default)({}, a, {
                className: c
            }))
        };
    ...
    function a(e) {
        ...
        }, Math.round(100 * e.percentVote) / 100, "%"), w.a.createElement("span", {
            className: "cv-choice-text"
        }, e.choice.text), e.isSelected ? w.a.createElement(u.a, {
        ...
        k = function (e) {
            function t() {
                ...
                return n = i = o(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(l))), i.calculatePercentage = function (e) {
                    ...
                    var t = new Date(e.expirationDateTime).getTime(),
                        n = (new Date).getTime(),
                        r = t - n,
            ...
            return i(t, e), _(t, [{
                ...
                value: function () {
                    ...
                    return w.a.createElement("div", {
                        ...
                        style: {
                            backgroundColor: Object(x.a)(this.props.poll.createdBy.name)
                        }
                    }, this.props.poll.createdBy.name[0].toUpperCase()), w.a.createElement("span", {
                        className: "poll-creator-name"
                    }, this.props.poll.createdBy.name), w.a.createElement("span", {
                        className: "poll-creator-username"
                    }, "@", this.props.poll.createdBy.username), w.a.createElement("span", {
                        className: "poll-creation-date"
                    }, Object(E.b)(this.props.poll.creationDateTime)))), w.a.createElement("div", {
                        className: "poll-question"
                    }, this.props.poll.question)), w.a.createElement("div", {
                    ...
                    }, this.props.poll.selectedChoice || this.props.poll.expired ? null : w.a.createElement(p.a, {
                        className: "vote-button",
                        disabled: !this.props.currentVote,
                        onClick: this.props.handleVoteSubmit
                    }, "Vote"), w.a.createElement("span", {
                        className: "total-votes"
                    }, this.props.poll.totalVotes, " votes"), w.a.createElement("span", {
                        className: "separator"
                    }, "\u2022"), w.a.createElement("span", {
                        className: "time-left"
            ...
            return (0, h.default)(t, e), (0, c.default)(t, [{
                ...
                value: function () {
                    var e = this,
                        t = this.props,
                        n = t.prefixCls,
                        r = void 0 === n ? "ant-radio-group" : n,
                        o = t.className,
                        i = void 0 === o ? "" : o,
                        s = t.options,
                        l = (0, w.default)(r, (0, a.default)({}, r + "-" + t.size, t.size), i),
                        u = t.children;
            ...
            return (0, m.default)(t, e), (0, f.default)(t, [{
                ...
                value: function () {
                    ...
                    return y.isValidElement(n) ? y.cloneElement(n, {
                        className: (0, C.default)(n.props.className, r)
                    }) : y.createElement("span", {
                        className: (0, C.default)(r, t + "-dot-spin")
                    }, y.createElement("i", null), y.createElement("i", null), y.createElement("i", null), y.createElement("i", null))
                }
            }, {
                key: "render",
                value: function () {
                    var e, t = this.props,
                        ...
                        u = T(t, ["className", "size", "prefixCls", "tip", "wrapperClassName"]),
                        c = this.state,
                        f = c.spinning,
                        p = c.notCssAnimationSupported,
                        ...
                        m = y.createElement("div", (0, i.default)({}, h, {
                            className: d
                        }), this.renderIndicator(), a ? y.createElement("div", {
                            className: o + "-text"
                        }, a) : null);
    ...
    function r() {
        ...
        if (void 0 !== t.style.animationName && (o = !0), void 0 !== o)
            for (var n = 0; n < e.length; n++)
        ...
        L = function (e) {
            ...
            return a(t, e), F(t, [{
                ...
                value: function (e) {
                    var t = this.state.choices.slice();
                    this.setState({
                        choices: [].concat(r(t.slice(0, e)), r(t.slice(e + 1)))
                    })
                }
            }, {
                key: "handleSubmit",
                value: function (e) {
                    ...
                    var n = {
                        ...
                        choices: this.state.choices.map(function (e) {
                            return {
                                text: e.text
                            }
                        }),
                ...
                value: function (e) {
                    ...
                    this.setState({
                        question: Object.assign({
                            text: t
                        }, this.validateQuestion(t))
                    })
                }
            }, {
                key: "handleChoiceChange",
                value: function (e, t) {
                    var n = this.state.choices.slice(),
                        r = e.target.value;
                    n[t] = Object.assign({
                        text: r
                    }, this.validateChoice(r)), this.setState({
                        choices: n
                    })
                }
            }, {
                key: "handlePollDaysChange",
                value: function (e) {
                    var t = Object.assign(this.state.pollLength, {
                        days: e
                    });
                    this.setState({
                        pollLength: t
                ...
                value: function () {
                    ...
                    return this.state.choices.forEach(function (n, r) {
                    ...
                    }, "Create Poll"), N.a.createElement("div", {
                        ...
                        type: "plus"
                    }), " Add a choice")), N.a.createElement(I, {
                        className: "poll-form-row"
            ...
            return (0, m.default)(t, e), (0, f.default)(t, [{
                ...
                value: function () {
                    ...
                    var f = l ? y.createElement(_.default, {
                            ...
                            key: "enterButton"
                        }, !0 === l ? y.createElement(x.default, {
                            type: "search"
                        }) : l) : y.createElement(x.default, {
                            className: r + "-icon",
                            type: "search",
                            key: "searchIcon"
                        }),
                    ...
                    return y.createElement(C.default, (0, i.default)({
    ...
    var a = n(2),
        ...
        P = function (e) {
                ...
                return e.state = {
                    ...
                    if (t && e.textAreaRef) {
                        var n = t ? t.minRows : null,
                            r = t ? t.maxRows : null,
                            o = (0, _.default)(e.textAreaRef, !1, n, r);
                        e.setState({
                            textareaStyles: o
                        })
                    }
            ...
            return (0, y.default)(t, e), (0, d.default)(t, [{
                ...
                value: function () {
                    var e = this.props,
                        t = (0, C.default)(e, ["prefixCls", "onPressEnter", "autosize"]),
        ...
        D = function (e) {
            ...
            return (0, m.default)(t, e), (0, f.default)(t, [{
                ...
                value: function () {
                    ...
                    return y.createElement("form", (0, i.default)({}, c, {
                        className: u
                    }))
                }
            }]), t
    ...
    t.default = D, D.defaultProps = {
        ...
        vertical: b.default.bool
    }, D.Item = A.default, D.createFormField = _.default, D.create = function () {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
        return (0, x.default)((0, i.default)({
            fieldNameProp: "id"
        }, e, {
    ...
    var s = n(2),
        ...
        b = {
            getForm: function () {
                return (0, l.default)({}, y.mixin.getForm.call(this), {
                    validateFieldsAndScroll: this.validateFieldsAndScroll
                })
            },
            validateFieldsAndScroll: function (e, t, n) {
                var r = this,
                    o = (0, g.getParams)(e, t, n),
                    a = o.names,
                    s = o.callback,
                    u = o.options,
                    f = function (e, t) {
                            ...
                            try {
                                for (var v, y = n[Symbol.iterator](); !(f = (v = y.next()).done); f = !0) {
                                    ...
                                    if ((0, h.default)(e, g)) {
                                        ...
                                        if (b) {
                                            var w = c.default.findDOMNode(b),
                                                C = w.getBoundingClientRect().top;
            ...
            if (n) {
                ...
                for (var a in n)
                    if (n.hasOwnProperty(a) && a !== l) {
                        ...
                        if (o(c, a), w.hasOwnProperty(a)) w[a](e, u);
                        else {
        ...
        validate: function (e) {
            ...
            (f.keys || Object.keys(this.rules)).forEach(function (t) {
                h = n.rules[t], m = u[t], h.forEach(function (r) {
                    var o = r;
                    "function" === typeof o.transform && (u === e && (u = i()({}, u)), m = u[t] = o.transform(m)), o = "function" === typeof o ? {
                        validator: o
                    } : i()({}, o), o.validator = n.getValidationMethod(o), o.field = t, o.fullField = o.fullField || t, o.type = n.getType(o), o.validator && (v[t] = v[t] || [], v[t].push({
                        rule: o,
                        value: m,
                        source: u,
                        field: t
            ...
            Object(l.a)(v, f, function (e, t) {
                ...
                function o() {
                    ...
                    if (u) {
                        ...
                        var c = {};
                        if (a.defaultField)
                            for (var p in e.value) e.value.hasOwnProperty(p) && (c[p] = a.defaultField);
                        c = i()({}, c, e.rule.fields);
                        for (var d in c)
    ...
    function r(e, t, n, r, i) {
        if (e.pattern)
            if (e.pattern instanceof RegExp) e.pattern.lastIndex = 0, e.pattern.test(t) || r.push(o.d(i.messages.pattern.mismatch, e.fullField, t, e.pattern));
    ...
    var h = n(153),
        ...
        b = function () {
            ...
            return (0, d.default)(e, [{
                ...
                key: "getField",
                value: function (e) {
                    return (0, u.default)({}, this.fields[e], {
                        name: e
                    })
                }
            }, {
        ...
        w = function () {
            ...
            this.setFieldsInitialValue = function (t) {
                ...
                Object.keys(n).forEach(function (t) {
                    r[t] && e.setFieldMeta(t, (0, u.default)({}, e.getFieldMeta(t), {
                        initialValue: n[t]
                    }))
                })
        ...
        I = function (e) {
            ...
            return (0, v.default)(t, e), (0, p.default)(t, [{
                ...
                value: function (e) {
                    ...
                    return g.createElement(j.default, (0, l.default)({}, r, {
                        className: o,
                        key: "wrapper"
                    }), e)
                }
                ...
                value: function () {
                    var e = this.props,
                        ...
                        f = (0, E.default)((0, a.default)({}, t + "-item-required", u)),
                        p = n;
                ...
                value: function (e) {
                    ...
                    return g.createElement(N.default, {
                        className: (0, E.default)(i),
                        style: o
                    }, e)
                }
            }, {
    ...
    var j = function () {
        ...
        this.componentWillReceiveProps = function (t) {
            if ("value" in t) {
                ...
                n = e.addLabelToValue(t, n), n = e.addTitleToValue(t, n), e.setState({
                    value: n
                }), t.combobox && e.setState({
                    inputValue: n.length ? e.getLabelFromProps(t, n[0].key) : ""
                })
            }
            ...
            e.setInputValue(r), e.setState({
                open: !0
            }), Object(T.k)(e.props) && e.fireChange([{
                key: r
            }])
            ...
            return Array.isArray(t) || (o = [t]), h.a.Children.forEach(n, function (t) {
                if (t)
                    if (t.type.isSelectOptGroup) e.getOptionsFromChildren(t.props.children, r);
                    else {
                        var n = Object(T.e)(o, Object(T.i)(t)); - 1 !== n && (r[n] = t)
                    }
            ...
            return e.getOptionsFromChildren({
                key: t,
                label: t
            }, e.props.children)
            ...
            var t, n = e.props,
                r = n.getInputElement ? n.getInputElement() : h.a.createElement("input", {
                    id: n.id,
                    autoComplete: "off"
                }),
            ...
            t !== e.state.inputValue && (e.setState({
                inputValue: t
            }), n && e.props.onSearch(t))
        }, this.handleBackfill = function (t) {
            if (e.props.backfill && (Object(T.n)(e.props) || Object(T.k)(e.props))) {
                var n = Object(T.i)(t),
                    r = e.getLabelFromOption(t),
                    o = {
                        key: n,
                        label: r,
                        backfill: !0
                    };
                Object(T.k)(e.props) && e.setInputValue(n, !1), e.setState({
                    value: [o]
                })
            }
        }, this.filterOption = function (t, n) {
            var r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : T.c,
                o = e.state.value,
                i = o[o.length - 1];
            ...
            return h.a.Children.forEach(t.children, function (t) {
                if (t)
                    if (t.type.isSelectOptGroup) r = e.addTitleToValue(t.props, r);
                    else {
                        var n = Object(T.i)(t),
                            i = o.indexOf(n);
            ...
            if (!n.disabled && !e.isChildDisabled(t)) {
                var r = void 0,
                    o = e.state.value.filter(function (e) {
                ...
                if (Object(T.l)(n)) {
                    ...
                    n.labelInValue && (i = {
                        key: t,
                        label: r
                    }), n.onDeselect(i, e.getSingleOptionByValueKey(t))
                }
                e.fireChange(o)
            }
            ...
            if (o) {
                ...
                if (c = c.filter(function (e) {
                    ...
                    }) && u.unshift(h.a.createElement(E.Item, {
                        style: T.b,
                        attribute: T.a,
                        value: t,
                        key: t
                ...
                if (t)
                    if (t.type.isSelectOptGroup) {
                        ...
                        if (Object(T.s)(f, e.props), e.filterOption(s, t)) {
                            var p = h.a.createElement(E.Item, a()({
                                style: T.b,
                                attribute: T.a,
                                value: f,
                                key: f
            ...
            if (Object(T.n)(i)) {
                ...
                if (void 0 !== c && n.length > c) {
                    O = O.slice(0, c);
                    var E = e.getVLForOnChange(n.slice(c, n.length)),
                        _ = "+ " + (n.length - c) + " ...";
                    f && (_ = "function" === typeof f ? f(E) : f), x = h.a.createElement("li", a()({
                        style: T.b
                    }, T.a, {
                        onMouseDown: T.o,
                        ...
                        className: l + "-selection__choice__content"
                    }, _))
                }
                Object(T.l)(i) && (w = O.map(function (t) {
                    ...
                    return h.a.createElement("li", a()({
                        ...
                        className: l + "-selection__choice__content"
                    }, n), o ? null : h.a.createElement("span", {
            ...
            onDeselect: function (e) {
                ...
                if (t.selectable) {
                    var n = this.state.selectedKeys.concat(),
                        r = e.key,
                        i = n.indexOf(r); - 1 !== i && n.splice(i, 1), "selectedKeys" in t || this.setState({
                        selectedKeys: n
                    }), t.onDeselect(o()({}, e, {
                        selectedKeys: n
                    }))
        ...
        O = function (e) {
            ...
            return c()(t, e), t.prototype.componentDidMount = function () {
                ...
                return s ? p.a.createElement(g.default, {
                    ...
                    visible: !0
                }, f), t.children)) : null) : p.a.createElement(g.default, {
                    component: "",
                    exclusive: !0,
                    transitionAppear: !0,
                    transitionName: this.getTransitionName(),
    ...
    function r(e, t, n, r, i) {
        ...
        return {
            left: e.left - l[0] + r[0] - i[0],
            top: e.top - l[1] + r[1] - i[1]
        }
    }
    var o = n(411);
    t.a = r
    ...
    var r = n(2),
        ...
        m = c()({
            ...
            render: function () {
                ...
                var l = o()({}, t.style);
                return "inline" === t.mode && (l.paddingLeft = t.inlineIndent * t.level), a.a.createElement("li", o()({}, i, s, {
                    style: l
                }), t.children)
            }
        });
    ...
    var r = n(0),
        ...
        u = l()({
            ...
            render: function () {
                ...
                }, e.title), o.a.createElement("ul", {
                    className: a
                }, o.a.Children.map(e.children, this.renderInnerMenuItem)))
            }
        });
        ...
        _ = function (e) {
            function t() {
                ...
                return n = r = c()(this, e.call.apply(e, [this].concat(s))), r.state = {
                    ...
                    var t = r.props;
                    return m.a.createElement(w.a, a()({
                        ref: Object(x.p)(r, "dropdownMenuRef")
                    }, e, {
    ...
    t.default = g, g.contextTypes = {
        antLocale: y.default.object
    }, e.exports = t.default
}, function (e, t, n) {
    "use strict";
        ...
        N = function (e) {
            ...
            return i(t, e), k(t, [{
                ...
                value: function () {
                    ...
                    }, "Login"), "Or ", O.a.createElement(_.b, {
                        to: "/signup"
                    }, "register now!")))
                }
            }]), t
            ...
            return a(t, e), _(t, [{
                ...
                value: function (e, t) {
                    var n = e.target,
                        o = n.name,
                        i = n.value;
                    this.setState(r({}, o, Object.assign({
                        value: i
                    }, t(i))))
                }
            }, {
                ...
                value: function () {
                    ...
                    return w.a.createElement("div", {
                        ...
                        disabled: this.isFormInvalid()
                    }, "Sign up"), "Already registed? ", w.a.createElement(x.b, {
                        to: "/login"
                    }, "Login now!")))))
                }
            }, {
                ...
                value: function () {
                    var e = this,
                        t = this.state.username.value,
                        n = this.validateUsername(t);
                    if ("error" === n.validateStatus) return void this.setState({
                ...
                value: function () {
                    var e = this,
                        t = this.state.email.value,
                        n = this.validateEmail(t);
                    if ("error" === n.validateStatus) return void this.setState({
                        email: Object.assign({
                            value: t
                        }, n)
        ...
        E = function (e) {
            function t(e) {
                ...
                return n.state = {
                    user: null,
                    isLoading: !1
                }, n.loadUserProfile = n.loadUserProfile.bind(n), n
            }
            return i(t, e), O(t, [{
                key: "loadUserProfile",
                value: function (e) {
                    ...
                    this.setState({
                        isLoading: !0
                    }), Object(m.h)(e).then(function (e) {
                        t.setState({
                            user: e,
                            isLoading: !1
                        })
                    }).catch(function (e) {
                        404 === e.status ? t.setState({
                            notFound: !0,
                            isLoading: !1
                        }) : t.setState({
                            serverError: !0,
                ...
                value: function () {
                    ...
                    return d.a.createElement("div", {
                        className: "profile"
                    }, this.state.user ? d.a.createElement("div", {
                        ...
                        style: {
                            backgroundColor: Object(v.a)(this.state.user.name)
                        }
                    }, this.state.user.name[0].toUpperCase())), d.a.createElement("div", {
                        className: "user-summary"
                    }, d.a.createElement("div", {
                        className: "full-name"
                    }, this.state.user.name), d.a.createElement("div", {
                        className: "username"
                    }, "@", this.state.user.username), d.a.createElement("div", {
                        className: "user-joined"
                    }, "Joined ", Object(y.a)(this.state.user.joinedAt)))), d.a.createElement("div", {
    ...
    var a = n(2),
        ...
        S = function (e) {
            function t(e) {
                ...
                N.call(n);
                var r = void 0;
                return r = "activeKey" in e ? e.activeKey : "defaultActiveKey" in e ? e.defaultActiveKey : o(e), n.state = {
                    activeKey: r
                }, n
            }
            return b()(t, e), m()(t, [{
                ...
                value: function (e) {
                    ...
                    }) : i(e, this.state.activeKey) || this.setState({
                        activeKey: o(e)
                    })
                }
            }, {
    ...
    t.default = {
        ...
        setNextPrev: function () {
            ...
            return l = o < 0, this.setNext(s), this.setPrev(l), {
                next: s,
                prev: l
            }
        },
    ...
    t.default = {
        ...
        getTabs: function () {
            ...
            return f.default.Children.forEach(n, function (t, s) {
                if (t) {
                    ...
                    c += " " + o + "-tab";
                    var p = {};
                    t.props.disabled ? c += " " + o + "-tab-disabled" : p = {
                        onClick: e.onTabClick.bind(e, l)
                    };
                    var d = {};
        ...
        getRootNode: function (e) {
            var t = this.props,
                ...
                m = (0, d.default)(n + "-bar", (0, i.default)({}, o, !!o)),
                y = "top" === p || "bottom" === p,
                g = y ? {
                    float: "right"
                } : {},
            ...
            return a && (w = [(0, c.cloneElement)(a, {
                ...
                key: "content"
            })], w = y ? w : w.reverse()), f.default.createElement("div", (0, u.default)({
                role: "tablist",
                className: m,
                tabIndex: "0",
        ...
        h = function (e) {
            ...
            return i(t, e), d(t, [{
                ...
                value: function () {
                    ...
                    }, "500"), c.a.createElement("div", {
                        className: "server-error-desc"
                    }, "Oops! Something went wrong at our Server. Why don't you go back?"), c.a.createElement(p.b, {
                        to: "/"
                    }, c.a.createElement(l.a, {
    ...
    function a(e) {
        ...
        }, e.currentUser.name), w.a.createElement("div", {
            className: "username-info"
        }, "@", e.currentUser.username)), w.a.createElement(m.a.Divider, null), w.a.createElement(m.a.Item, {
            key: "profile",
            className: "dropdown-item"
        }, w.a.createElement(C.b, {
            to: "/users/" + e.currentUser.username
        }, "Profile")), w.a.createElement(m.a.Item, {
            key: "logout",
            className: "dropdown-item"
        }, "Logout"));
    ...
    var s = n(456),
        ...
        k = function (e) {
            ...
            return i(t, e), _(t, [{
                ...
                value: function () {
                    var e = void 0;
                    return e = this.props.currentUser ? [w.a.createElement(m.a.Item, {
                        key: "/"
                    }, w.a.createElement(C.b, {
                        to: "/"
                    }, w.a.createElement(p.a, {
                        ...
                        to: "/login"
                    }, "Login")), w.a.createElement(m.a.Item, {
                        key: "/signup"
                    }, w.a.createElement(C.b, {
                        to: "/signup"
                    }, "Signup"))], w.a.createElement(P, {
                        ...
                        to: "/"
                    }, "Polling App")), w.a.createElement(m.a, {
                        className: "app-menu",
                        mode: "horizontal",
    ...
    var s = n(0),
        ...
        v = function (e) {
            function t(n) {
                ...
                return y.call(r), r.state = "visible" in n ? {
                    visible: n.visible
                } : {
        ...
        P = function (e) {
            ...
            return (0, d.default)(t, e), (0, u.default)(t, [{
                ...
                value: function () {
                    ...
                    return "visible" in this.props && (g.visible = f), m.createElement(_, (0, i.default)({}, v, {
                        className: (0, x.default)(a, s)
                    }), m.createElement(y.default, {
                        type: t,
                        disabled: n,
                        onClick: r
                    }, o), m.createElement(C.default, g, m.createElement(y.default, {
                        type: t
    ...
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.default = o, t.cancelRequestAnimationFrame = i;
    var a = ["moz", "ms", "webkit"]
}, function (e, t, n) {
    "use strict";
    ...
    C.contextTypes = {
        antdMenuTheme: y.default.string
    }, t.default = C, e.exports = t.default
}, function (e, t, n) {
    "use strict";
        ...
        C = function (e) {
            ...
            return (0, d.default)(t, e), (0, u.default)(t, [{
                ...
                value: function () {
                    ...
                    }, m.createElement(v.Item, (0, i.default)({}, t, {
    ...
    C.contextTypes = {
        inlineCollapsed: g.default.bool
            ...
            return (0, d.default)(t, e), (0, u.default)(t, [{
                ...
                value: function () {
                    ...
                    var f = this.getDisabledCompatibleChildren(y.isValidElement(u) ? u : y.createElement("span", null, u)),
                        p = f.props,
                        d = (0, C.default)(p.className, (0, i.default)({}, a || n + "-open", !0));
